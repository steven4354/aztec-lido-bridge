...
contract NotionalBridge is IDefiBridge {
    ...
    {
        require(msg.sender == rollupProcessor, 'NotionalBridge: Invalid Caller');
        require(inputAssetA.assetType == Types.AztecAssetType.ETH, 'NotionalBridge: Invalid Input Token');
        // TODO:
        // require(
